...
Original file is located at
    https://colab.research.google.com/drive/1BLiDZUMRch-LOSeqJftTaC68EQtDKBpj
...
else: # Add an else statement to handle the case if 'risiko_readmisi' is not in the columns
    pass # Pass if it's not in the columns, indicating no action needed
